...
public class TrainerCommandTree {
    ...
    public void register(CommandDispatcher<ServerCommandSource> dispatcher) {
        ...
        dispatcher.register(LiteralArgumentBuilder.<ServerCommandSource>
            ...
            .then(LiteralArgumentBuilder.<ServerCommandSource>
                literal("setbattletype")
                .requires(editCommandRequirement)
                .then(RequiredArgumentBuilder.<ServerCommandSource, String>
                    argument("trainer", string())
                    .suggests(new TrainerNameSuggestionProvider())
                    .then(RequiredArgumentBuilder.<ServerCommandSource, String>
                        argument("battleType", string())
                        .suggests((context, builder) -> {
                            builder.suggest("singles");
                            builder.suggest("doubles");
                            return builder.buildFuture();
                        })
                        .executes(new SetBattleTypeCommand())
                    )
                )
            )
            .then(LiteralArgumentBuilder.<ServerCommandSource>
                ...
                .then(RequiredArgumentBuilder.<ServerCommandSource, String>
                    ...
                    .then(RequiredArgumentBuilder.<ServerCommandSource, Integer>
                        argument("aiLevel", integer(-1, 11))
                        .suggests((context, builder) -> {
                            for (int i = -1; i <= 11; i++) builder.suggest(i);
                            return builder.buildFuture();
                        })
                        .executes(new SetAILevelCommand())
                    )
                )
            )
            .then(LiteralArgumentBuilder.<ServerCommandSource>
                literal("setrandomizeleads")
                .requires(editCommandRequirement)
                .then(RequiredArgumentBuilder.<ServerCommandSource, String>
                    argument("trainer", string())
                    .suggests(new TrainerNameSuggestionProvider())
                    .then(RequiredArgumentBuilder.<ServerCommandSource, Boolean>
                        argument("randomizeLeads", bool())
                        .executes(new SetRandomizeLeadsCommand())
                    )
                )
            )
            .then(LiteralArgumentBuilder.<ServerCommandSource>
            ...
            .then(LiteralArgumentBuilder.<ServerCommandSource>
                literal("usescoreai")
                .requires(editCommandRequirement)
                .executes(new UseScoreAICommand())
            )
            .then(LiteralArgumentBuilder.<ServerCommandSource>
                literal("aidebug")
                .requires(editCommandRequirement)
